...
public class TravisHealth : MonoBehaviour
{
    [SerializeField] private int health = 125;
    ...
    // Method to load the main title scene
    private void LoadMainMenu()
    {
        // Load the scene with the specified name (make sure it's added to the build settings)
